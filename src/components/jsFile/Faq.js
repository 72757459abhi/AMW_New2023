...
const Faq = () => {
  ...
  return (
    <main className={"faqContainer"}>
      ...
      <h3 className={"headingText"}>What are Nails</h3>
      <br />
      <br />
      ...
      <br />
      <h3 className={"headingText"}>Diffrent Types of Shanks & Dia</h3>
      <br />
      <br />
      ...
      <br /> <br />
      <br />
      <h3 className={"headingText"}>Size Charts for Nails</h3>
      <br />
      <br />
      ...
      <br /> <br />
      <br />
      <h3 className={"headingText"}>Terminology</h3>
      <br />
      <br />
      <div className="terminologyText">
        <ul>
          <li>
